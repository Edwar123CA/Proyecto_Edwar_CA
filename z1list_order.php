    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index2.html" class="navbar-brand mx-4 mb-3">
                ...
                <div class="navbar-nav w-100">
                    <a href="index2.html" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Orders</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="z1new_orders.php" class="dropdown-item"><i class="fas fa-plus-circle"></i> New Order</a>
                            <a href="z1list_order.php" class="dropdown-item"><i class="fas fa-list-ul"></i> List Orders</a>
                            <a href="element.html" class="dropdown-item"><i class="fas fa-cube"></i> Other Elements</a>
                        </div>
                    </div>
                    <!--PROBANDO NUEVOS-->
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="z2list_customer.php" class="dropdown-item"><i class="fas fa-list-alt"></i> List Customer</a>
                    ...
                    <a href="404.html" class="nav-item nav-link"><i class="fas fa-question-circle"></i> Help</a>
                    <!--PROBANDO NUEVOS-->
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Edwar R.</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                ...
                <div class="bg-secondary text-center rounded p-0">
                    <div class="d-flex align-items-center justify-content-between mb-0">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                                <a href="z1new_orders.php" class="btn btn-warning"><i class="bi bi-plus"></i> New Orden</a>
                            </div>
                    </div>
